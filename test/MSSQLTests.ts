    ...
    it('select tests',function(done){
        factory.onReady(async ()=>{
            ...
            try {
                    ...
                    var results = await db.fetch();
                    selectQuery = db.generateSelect().trim();
                    expect(selectQuery).to.match(/^SELECT(?: )+\*,CASE WHEN(?: )+cities.city(?: )+=(?: )+\@weight1000(?: )+THEN(?: )+100(?: )+ELSE(?: )+0(?: )+END(?: )+\+(?: )+CASE WHEN(?: )+cities.city(?: )+=(?: )+\@weight500(?: )+THEN(?: )+50(?: )+ELSE(?: )+CASE WHEN(?: )+genders.gender(?: )+=(?: )+\@weight400(?: )+THEN(?: )+40(?: )+ELSE(?: )+0(?: )+END(?: )+END(?: )+__condition_weight__,CASE WHEN(?: )+cities.city(?: )+=(?: )+\@weight1001(?: )+THEN(?: )+100(?: )+ELSE(?: )+0(?: )+END(?: )+\+(?: )+CASE WHEN(?: )+cities.city =(?: )+\@weight501(?: )+THEN(?: )+50(?: )+ELSE CASE WHEN(?: )+genders.gender =(?: )+\@weight401(?: )+THEN 40 ELSE 0 END END __condition_weight__ FROM(?: )+users(?: )+JOIN(?: )+cities ON(?: )+cities.id =(?: )+users.city_id(?: )+JOIN(?: )+genders ON(?: )+genders.id =(?: )+users.gender_id(?: )+WHERE(?: )+cities.city(?: )+IN(?: )+\(@param4,@param5,@param6\)(?: )+ORDER BY __condition_weight__ desc,__condition_weight__ desc/);
